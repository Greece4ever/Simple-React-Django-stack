...
const Collapse = (props) => {
    return(
        <div style={{"cursor" : "pointer"}} data-toggle="modal" data-target="#peos" onClick={() => {props.setFileURI(props.url)}} style={{"border" : "0"}} id="accordion">
            <div style={{"border" : "0","cursor" : "pointer"}} className="card">
                ...
                <h5 className="mb-0">
                    ...
                    {/* <label style={{position : "absolute","right" : "10px",fontSize : "15px",top : "2px"}} className="text-muted">{props.name.split(".")[1].toUpperCase() + " File" }</label> */}
                </h5>
                </div>
            </div>
        </div>
